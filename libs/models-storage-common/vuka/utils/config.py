# https://raw.githubusercontent.com/qijiezhao/M2Det/master/configs/CC.py
...
class Config(object):
    ...
    def from_dict(my_dict):
        ...
        # фильтруем нежелательные объекты
        for name, value in my_dict.items():
            if not name.startswith("__") and types_filtrator(value):
                cfg_dict[name] = value
